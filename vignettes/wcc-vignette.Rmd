...
```{r one layer weighted consensus clustering, fig.show='hold', warning=FALSE, cache=TRUE}
...
```{r two-layer weighted consensus clustering, fig.show='hold', warning=FALSE, cache=TRUE}
  #norm
