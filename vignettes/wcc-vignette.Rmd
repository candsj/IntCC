...
```{r one layer weighted consensus clustering, fig.show='hold', eval=FALSE,warning=FALSE, cache=TRUE}
...
```{r two-layer weighted consensus clustering, fig.show='hold', eval=FALSE,warning=FALSE, cache=TRUE}
  #norm
