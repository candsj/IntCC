...
```{r 1 layer intCC, fig.show='hold', eval=FALSE,warning=FALSE, cache=TRUE}
...
```{r 1 layer intCC, fig.show='hold', warning=FALSE, eval=FALSE,cache=TRUE}
#1 layer
...
```{r 2 layer intCC, fig.show='hold', eval=FALSE,warning=FALSE, cache=TRUE}  
  #norm
...
```{r 2 layer intCC, fig.show='hold', warning=FALSE, eval=FALSE,cache=TRUE}
  #2 layer
  data_for_intCC <- list()
