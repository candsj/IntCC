...
```{r load data, fig.show='hold', eval=FALSE,warning=FALSE, cache=FALSE}
...
```{r consensus_cluster, fig.show='hold', eval=FALSE,warning=FALSE, cache=FALSE}
...
```{r one layer wcc, fig.show='hold', eval=FALSE,warning=FALSE, cache=FALSE}
...
```{r two-layer wcc, fig.show='hold', eval=FALSE,warning=FALSE, cache=FALSE}
  #norm
...
```{r klic, fig.show='hold', warning=FALSE, eval=FALSE,cache=FALSE}
#one layer
...
```{r heatmap, fig.show='hold', warning=FALSE, eval=FALSE,cache=FALSE}
