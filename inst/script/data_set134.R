...
for (i in 1:100) {
  ...
  data_for_klic[[3]]=poisData
  data_for_klic[[4]]=multData
  data_for_klic[[5]]=noiseData
  
  data_set4[[i]]=data_for_klic
  
}

save(data_set1,file="/home/mercury02/huchuang/wcc/data/data_set1.RData")
save(data_set3,file="/home/mercury02/huchuang/wcc/data/data_set3.RData")
save(data_set4,file="/home/mercury02/huchuang/wcc/data/data_set4.RData")